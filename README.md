...
Clone the repository and navigate to the project directory to run the application using Maven:

```bash
git clone https://github.com/stefanrosu12/Minibank-Project.git
